        ...
        {isDropdownOpen && (
          <div className="absolute top-12 right-12 md:right-0 w-full mt-2 shadow-xl rounded-lg transition-all duration-300 opacity-100 z-[999] ">
            <button
              ...
              className="py-1 p-3 min-w-20   text-white bg-red-600 font-medium rounded-md hover:bg-red-700 transition z-[999] duration-300 focus:outline-none text-xs md:text-base"
            >
              Sign Out
            </button>
          </div>
